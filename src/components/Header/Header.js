...
import ContentContainer from '../shared/UIElements/ContentContainer/ContentContainer';
import Modal from '../shared/UIElements/Modal/Modal';
import NavLinks from './NavLinks/NavLinks';
import SideDrawer from '../shared/UIElements/SideDrawer/SideDrawer';
		...
		<React.Fragment>
			<header>
				<div className="header-inner-wrapper">
					{!isMobile && <HeaderProfileDropdown id="header-profile-button" name="Jarrett Falasco" />}
					{isMobile && mobileHeaderContent}
				</div>
